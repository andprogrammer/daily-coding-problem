# https://github.com/r1cc4rdo/daily_coding_problem/blob/master/daily_coding_problem_41_45.py
# podobne dysk samsung /run/media/andrzej/SAMSUNG/DokumentyAndrzej/DynamicProgramming/setsofnumbers.py
...
if __name__ == '__main__':
    print(coding_problem_42([12, 1, 61, 5, 9, 2], 24))
